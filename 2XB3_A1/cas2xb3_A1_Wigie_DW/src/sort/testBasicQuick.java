...
public class testBasicQuick {
	...
	public void test() {
		...
		System.out.println("Timings for Basic Quicksort Sort (in microseconds): ");
		
		long startTime = System.nanoTime();
		a.sortBasicQuick(products);
		long endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSortedBasic(products));
		
		startTime = System.nanoTime();
		a.sortBasicQuick(products2);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSortedBasic(products2));
		
		startTime = System.nanoTime();
		a.sortBasicQuick(products3);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSortedBasic(products3));
		
		startTime = System.nanoTime();
		a.sortBasicQuick(products4);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSortedBasic(products4));
		
		startTime = System.nanoTime();
		a.sortBasicQuick(products5);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSortedBasic(products5));
		
		startTime = System.nanoTime();
		a.sortBasicQuick(products6);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSortedBasic(products6));
		
		startTime = System.nanoTime();
		a.sortBasicQuick(products7);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSortedBasic(products7));
	}
