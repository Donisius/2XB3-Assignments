...
public class testHeap {
	...
	public void test() {
		...
		System.out.println("Timings for Heap Sort (in microseconds): ");
		
		long startTime = System.nanoTime();
		a.sortHeap(products, products.length);
		long endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products));
		
		startTime = System.nanoTime();
		a.sortHeap(products2, products2.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products2));
		
		startTime = System.nanoTime();
		a.sortHeap(products3, products3.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products3));
		
		startTime = System.nanoTime();
		a.sortHeap(products4, products4.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products4));
		
		startTime = System.nanoTime();
		a.sortHeap(products5, products5.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products5));
		
		startTime = System.nanoTime();
		a.sortHeap(products6, products6.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products6));
		
		startTime = System.nanoTime();
		a.sortHeap(products7, products7.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
