...
public class testInsertBinary {
	...
	public void test() {
		...
		System.out.println("Timings for Binary Insertion Sort (in microseconds): ");
		
		long startTime = System.nanoTime();
		a.sortBinary(products, products.length);
		long endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products));
		
		startTime = System.nanoTime();
		a.sortBinary(products2, products2.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products2));
		
		startTime = System.nanoTime();
		a.sortBinary(products3, products3.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products3));
		
		startTime = System.nanoTime();
		a.sortBinary(products4, products4.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products4));
		
		startTime = System.nanoTime();
		a.sortBinary(products5, products5.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products5));
		
		startTime = System.nanoTime();
		a.sortBinary(products6, products6.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products6));
		
		startTime = System.nanoTime();
		a.sortBinary(products7, products7.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
