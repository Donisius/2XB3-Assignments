...
public class testMergeBU {
	...
	public void test() {
		...
		System.out.println("Timings for Bottom Up Merge Sort (in microseconds): ");
		
		long startTime = System.nanoTime();
		a.sortMergeBU(products, products.length);
		long endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products));
		
		startTime = System.nanoTime();
		a.sortMergeBU(products2, products2.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products2));
		
		startTime = System.nanoTime();
		a.sortMergeBU(products3, products3.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products3));
		
		startTime = System.nanoTime();
		a.sortMergeBU(products4, products4.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products4));
		
		startTime = System.nanoTime();
		a.sortMergeBU(products5, products5.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products5));
		
		startTime = System.nanoTime();
		a.sortMergeBU(products6, products6.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
		assertTrue(a.isSorted(products6));
		
		startTime = System.nanoTime();
		a.sortMergeBU(products7, products7.length);
		endTime = System.nanoTime();
		System.out.println((endTime - startTime)/1000);
